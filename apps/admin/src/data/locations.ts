...
// Source of truth: apps/reporter/src/data/locations.ts - keep this file
// in sync. Assembly constituencies grouped by district slug; the admin
// KYC wizard imports `pincodeToConstituency` from ./pincodes alongside
// these to auto-fill the city field from a pincode.
