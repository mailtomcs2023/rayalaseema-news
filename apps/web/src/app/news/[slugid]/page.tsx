// Legacy article route. Articles now live at /telugu-news/<category>/<slug>
// (see lib/article-href.ts). This old /news/<slug>-<id8> path stays only to
...
// Old URLs carried a trailing -<id8> suffix; strip it to get the slug. Fall
// back to treating the whole segment as the slug (defensive).
...
export default async function LegacyNewsRedirect({ params }: { params: Params }) {
